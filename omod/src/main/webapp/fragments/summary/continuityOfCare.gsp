...
<div class="info-section">
    ...
    <div class="info-body summary-section">
        ...
        <div id="buttons">
            <button type="button" class="confirm"onclick="location.href='${ui.pageLink("registrationapp", "viewCcd", [patient: patient, returnUrl: returnUrl, appId: appId ])}';">
                ${ ui.message("registrationapp.continuityOfCare.document.view") }
            </button>
            <a class="button confirm right" href="#" onclick="refreshCcd(${ config.patientId },'${ui.pageLink("registrationapp", "viewCcd", [patient: patient, returnUrl: returnUrl, appId: appId ])}')">
...
<div class="info-section">
    ...
    <div class="info-body summary-section">
        ...
        <div id="import-buttons">
            <button type="button" class="confirm" onclick="importCCD(${ config.patientId }, '${ui.pageLink("registrationapp", "viewCcd", [patient: patient, returnUrl: returnUrl, appId: appId ])}')">
